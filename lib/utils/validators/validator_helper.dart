...
class KValidatorHelper {
  KValidatorHelper._();

  static bool isNull(dynamic value) => value == null;

  static String? isFieldNull(Object? value) {
    if (value == null) {
  ...
  static bool? isNullOrBlank(dynamic value) {
    ...
    // Pretty sure that isNullOrBlank shouldn't be validating
  ...
  static String? isEmpty(String? value) {
    if (value == null || value.toString().trim().isEmpty) return "value required";
    return null;
  }
  ...
  static String? isValidPassword(String value) {
    if (value.isEmpty) {
      ...
      return "password must have eight characters";
    }
    return null;
  }
  ...
  /// If first word only is true, then the example return is "12312"
